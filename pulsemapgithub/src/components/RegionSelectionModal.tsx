...
export default function RegionSelectionModal({ regions, onSelectRegion, isOpen }: RegionSelectionModalProps) {
    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-6 bg-[var(--bg)]/90 backdrop-blur-xl">
                ...
                >
                    <div className="text-center mb-10">
                        ...
                        <p className="text-[var(--ink-dim)] text-lg max-w-xl mx-auto font-medium">
                            Initialize tactical telemetry protocol. Choose a primary geographic zone to begin monitoring live conflict events.
                        </p>
                    </div>
